...
const PoolReportModal = ({ reportData, isOpen, onClose }) => {
  const { user } = useAuth();
  // console.log("reportData in PoolReportModal:", reportData);
...
export default PoolReportModal;
